...
function Modal ({project, closeModal} ) {
        const tech = project.tech.map((item, index) => {
            return <div className='tech_modal-p' key={index}> {item} </div>
        } )
        return ( 
            <>
    <div className='overlay_modal' onClick={closeModal}></div>
        <div className='div_modal' key={project.id}>
            <div className='div_modal-position'>
                ...
                <div className='info_modal'>                    
                    ...
                    <a className="github_modal" href={project.github} target="_blank" rel="noreferrer">
